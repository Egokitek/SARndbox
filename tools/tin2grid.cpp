/* A simple C++ program to create a “grid” file from real DEM data */
/* Courtesy of @sharned, 2016-Dec-28 */
/* This code is freely released to the public domain. */
/* https://arsandbox.ucdavis.edu/forums/topic/terrian-model/#post-102866 */
#include <iostream>
#include <fstream>
#include <sstream>
#include <string>
